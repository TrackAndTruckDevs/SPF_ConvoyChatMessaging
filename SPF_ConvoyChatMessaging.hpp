 ...
 * @brief Internal header for the SPF_ConvoyChatMessaging.
...
// #include <SPF_Icons.h>             // For Font Awesome 7 icon macros.
...
// #include <SPF_VirtInput_API.h>      // For SPF_VirtInput_API, SPF_VirtualDevice_Handle
// #include <SPF_Camera_API.h>         // For SPF_Camera_API
// #include <SPF_Vehicle_API.h>        // For SPF_Vehicle_API, SPF_VehicleHandle
...
// #include <SPF_JsonWriter_API.h>     // For creating and modifying JSON structures in memory.
// #include <SPF_JsonIO_API.h>         // For loading and saving JSON files.
// #include <SPF_Environment_API.h>   // For retrieving information about the game, framework, and system environment.
...
struct PluginContext {
  ...
  // SPF_JsonWriter_API* jsonWriterAPI = nullptr;       // Requires: SPF_JsonWriter_API.h
  // SPF_JsonIO_API* jsonIOAPI = nullptr;               // Requires: SPF_JsonIO_API.h
  // SPF_Config_Handle* customConfigHandle = nullptr;   // Demonstrates Cfg_CreateCustomContext
 ...
 * @details This is defined once in `SPF_ConvoyChatMessaging.cpp` and declared `extern` here, making it
